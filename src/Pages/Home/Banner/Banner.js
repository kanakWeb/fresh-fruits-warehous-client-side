    ...
    <div className="banner w-100">
     <div className="row container">
       <div className=" col-lg-8 col-md-12 col-sm-12 margin-top ">
         <h2 className="text-warning pt-5 margin-top-heading  fs-1 fw-bold">Get Friesh Fruits</h2>
         ...
         <button className="btn btn-warning margin-top text-light margin-bottom fs-5 px-2 fw-bold my-5">Explore Now</button>
       </div>
     </div>
    </div>
  );
